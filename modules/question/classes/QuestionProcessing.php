...
include_once dirname(__FILE__) . '/../dao/QuestionReadDao.php';
include_once dirname(__FILE__) . '/../dao/QuestionWriteDao.php';
include_once dirname(__FILE__) . '/../cache/QuestionCachingDao.php';
include_once dirname(__FILE__) . '/../models/QuestionTempData.php';
include_once dirname(__FILE__) . '/../models/Questions.php';
include_once dirname(__FILE__) . '/../models/QuestionGroups.php';
include_once dirname(__FILE__) . '/../models/QuestionOptions.php';
include_once dirname(__FILE__) . '/../models/QuestionTopics.php';
include_once dirname(__FILE__) . '/../models/QuestionMetadata.php';
include_once dirname(__FILE__) . '/../models/QuestionTopicMapping.php';
include_once dirname(__FILE__) . '/../models/QuestionClusterMapping.php';
include_once dirname(__FILE__) . '/../models/QuestionSolutions.php';
include_once dirname(__FILE__) . '/../models/QuestionVerification.php';
...
class QuestionProcessing{
	...
	private $cwrite;
	private $ccache;
	private $topics_mapping = array();
	private $sub_topics_mapping = array();
	private $image_arr = array();
	private $group_arr = array();
	private $failed_image_arr = array();
	private $subject_name = "";

	public function __construct($subject_name){
		$this->subject_name = $subject_name;
		$this->cread = new QuestionReadDao();
		$this->cwrite = new QuestionWriteDao();
		$this->ccache = new QuestionCachingDao();
	}
